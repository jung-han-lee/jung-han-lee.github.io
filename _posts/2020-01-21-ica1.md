...
We begin with the variant of ICA that maximizes  $$|K_4|$$  and show that ICA, via kurtosis maximization, does indeed recover the independent components.
...
What happens when we maximize  $$|K_4|$$  or equivalently use abs. kurtosis based ICA?
